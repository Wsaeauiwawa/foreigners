            ...
            <div class="col-md-12">
                <form method="post" id="insert_form">
                    ...
                    <div class="card mt-5" style="bottom: 20px;">
                        ...
                        <div class="card-body" id="item_table">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="form-control" type="date" name="dob[]" min="1900-12-31" max="3000-12-31" required >
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="d-flex justify-content-center">
                            <input class="btn btn-primary" type="submit" value="Submit" style="margin-left: 10px; margin-bottom: 10px;">
                        </div>
                    </div>
                </form>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.add', function() {
                ...
                html += 
                    '<div class="col-md-4"><label for="other">Other</label><input type="file" class="form-control" name="other[]" accept=".pdf">@error('photo')<span class="text-danger">{{$message}}</span>@enderror</div>';
                html +=
                    '<br><button type="button" name="remove" class="btn btn-danger btn-sm remove"><i class="fas fa-minus"></i></button></div>';
